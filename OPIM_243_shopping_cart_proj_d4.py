...
def create_cost_dictionary(product_identifier_dict, tax_rate):
    ...
    for identifier in product_identifier_dict:
        ...
        subtotal = subtotal + (float(products[identifier-1]['price']) * float(product_identifier_dict[identifier]))
...
def print_item_and_price(product_list, product_identifier_dict, identifier):
    if product_list[identifier-1]['price_per'] == 'item':
        print('+ ' + str(product_identifier_dict[identifier]) + ' ' +
        ...
        print('+ ' + str(product_identifier_dict[identifier]) + ' lbs ' +
...
def print_receipt(product_list, product_identifier_dict, cost_dictionary):
    ...
    for identifier in product_identifier_dict:
        print_item_and_price(product_list, product_identifier_dict, identifier)
    print('---------------------------------')
